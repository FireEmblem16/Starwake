...
///////////////////////////////// pill_addict.cpp /////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
/// Runs a robot AI that is addicted to energy pills and will try to get all of ///
/// them it possibly can. Requires no command line arguments.                   ///
///////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
#ifndef _PILL__ADDICT_CPP
#define _PILL__ADDICT_CPP
...
{
	// This is our robot
	Robot robot("robot","RO","MyPillAddict");
	robot.ChangeNature(new PillAddict());
	...
	while(((Command::MessageCode)cmd.GetCommand()) != Command::TERMINATE)
	{
		...
		else if(((Command::MessageCode)cmd.GetCommand()) == Command::MOVE)
		{
			...
			if(m->GetSuccess() == "true")
			{
				...
				{
					last = here;
					here = ((PillSeeker*)robot.GetNature()->GetMoveBehaviour())->GetDirection(here,PillSeeker::FORWARD);
				}
				else
				{
					...
					if(rotating_left)
						((PillSeeker*)robot.GetNature()->GetMoveBehaviour())->Rotate(PillSeeker::LEFT);
					else if(rotating_right)
						((PillSeeker*)robot.GetNature()->GetMoveBehaviour())->Rotate(PillSeeker::RIGHT);
				}
			}
