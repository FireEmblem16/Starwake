...
//
// Simple demonstration of using a 2D texture. No lighting, just maps
// an image onto an object with texture coordinates defined.  See
// fshader.glsl to see how to use the texture coordinates to sample.
//
// Edit the beginning of init() method to change the image
// or use a different object.
//
// Use arrow keys to orbit, w to move forward, s to move back.
// F1 sets mag filter to nearest
// F2 sets mag filter to linear
//
