...
//
// Fragment shader for per-fragment lighting calculation (Phong shading).
//
...
{ 
  ...
  // Remaining code is essentially copied from the vertex shader for per-vertex lighting
