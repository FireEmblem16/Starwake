...
{
	/// <summary>
	/// A tile representing a tile with a mountain in it.
	/// </summary>
	public class Mountain : Tile
	{
		/// <summary>
		/// Creates a new mountain tile.
		/// </summary>
		public Mountain()
		{return;}
		...
		{
			TileFactory.RegisterTile(new Pair<string,GenerateTile>("Mountain",CreateMountain));
			return;
		}
		...
		/// </summary>
		protected static Tile CreateMountain()
		{return new Mountain();}
