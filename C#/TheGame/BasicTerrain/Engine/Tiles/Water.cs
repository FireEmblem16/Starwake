...
{
	/// <summary>
	/// A tile representing a tile filled with water.
	/// </summary>
	public class Water : Tile
	{
		...
		{
			TileFactory.RegisterTile(new Pair<string,GenerateTile>("Water",CreateWater));
			return;
		}
		...
		/// </summary>
		protected static Tile CreateWater()
		{return new Water();}
		...
		public void Draw(Window win, int x, int y, bool fog_of_war)
		{
			...
			if(fog_of_war)
				win.SetColor(ConsoleColor.DarkCyan,ConsoleColor.DarkBlue);
			else
				win.SetColor(ConsoleColor.Cyan,ConsoleColor.Blue);
		...
		{
			if(fog_of_war)
				return new Pair<string,Pair<ConsoleColor,ConsoleColor>>("#",new Pair<ConsoleColor,ConsoleColor>(ConsoleColor.DarkCyan,ConsoleColor.DarkBlue));

			return new Pair<string,Pair<ConsoleColor,ConsoleColor>>("#",new Pair<ConsoleColor,ConsoleColor>(ConsoleColor.Cyan,ConsoleColor.Blue));
		}
