...
{
	/// <summary>
	/// The damage modifying ability for ground moving units.
	/// </summary>
	public class GroundMovementModifier : MovementAttackModifier
	{
		/// <summary>
		/// Creates a new ground movement modifier.
		/// </summary>
		public GroundMovementModifier()
		{return;}
		...
		{
			get
			{return "Ground Type\n-----------\nRepresents that the owner of this ability fights with ground attacks.";}
		}

		/// <summary>
		/// The source name of the ability.
		/// </summary>
		protected const string name = "Ground Type";
