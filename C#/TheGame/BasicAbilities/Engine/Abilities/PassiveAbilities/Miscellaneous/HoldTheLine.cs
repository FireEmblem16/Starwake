...
{
	/// <summary>
	/// A passive ability that halves damage if the unit doesn't move.
	/// </summary>
	public class HoldTheLine : PassiveAbility
	{
		/// <summary>
		/// Creates a new hold the line ability.
		/// </summary>
		public HoldTheLine()
		{return;}
		...
		{
			get
			{return "Hold the Line\n-------------\n\tHold the Line!\n\tWhen a unit with ability has not moved yet in the current round it takes half damage. Units that can move in the second movement phase may do so without penalty.\n\nCost: 11 points";}
		}

		/// <summary>
		/// The source name of the ability.
		/// </summary>
		protected const string name = "Hold The Line";
