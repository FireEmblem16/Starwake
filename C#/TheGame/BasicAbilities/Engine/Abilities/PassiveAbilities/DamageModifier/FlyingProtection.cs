...
{
	/// <summary>
	/// Represents a unit that has protection against flying attacks.
	/// </summary>
	public class FlyingProtection : DamageModifier
	{
		/// <summary>
		/// Creates a new flying protection ability.
		/// </summary>
		public FlyingProtection()
		{
			Level = 1;
			return;
		}
		...
		{
			if((type & ATTACK_TYPE.FLYING) == ATTACK_TYPE.FLYING)
				damage *= 0.5f;
		...
		{
			get
			{return "Aerial Cover\n------------\n\tWhat's the best way to defend yourself from attacks from above? Put a roof over your head. That's the philosophy that is adopted by those that have this ability but instead of a roof of wood they make do with a roof of steel spears.\n\tThis ability grants a reduction in damage from flying sources by half.\n\nCost: 14 points";}
		}

		/// <summary>
		/// The source name of the ability.
		/// </summary>
		protected const string name = "Aerial Cover";
