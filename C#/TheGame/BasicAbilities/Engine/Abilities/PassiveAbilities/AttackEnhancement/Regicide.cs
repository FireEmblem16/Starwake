...
{
	/// <summary>
	/// Represents a unit being particuarly good at knocking down leader units.
	/// </summary>
	public class Regicide : PassiveAbility
	{
		/// <summary>
		/// Creates a new regicide ability.
		/// </summary>
		public Regicide()
		{return;}
		...
		{
			get
			{return "Regicide\n--------\n\tSlaying a king or even a general is no easy task. Honor guard aside, they usually have some sort of magic sheild or blessed armor that makes injuring them rather difficult to say nothing of those pesky magic swords. Those that actually do the deed often study how to find weaknesses in defences and quickly learn that there's more than one way to kill a king.\n\tThis ability grants tripple damage against enemy leaders and ignores the leader defense bonus.\n\nCost: 25 points";}
		}

		/// <summary>
		/// The source name of the ability.
		/// </summary>
		protected const string name = "Regicide";
