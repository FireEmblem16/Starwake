...
/**
 * Facilitate the downloading of remote (or local) resources.
 */
public class WebGet extends Observable
{
    ...
    *     false otherwise
    */
    public synchronized boolean get(final URL sourceUrl, final String sourceDescription, final Object target)
    {
