...
public class FeyEthelCrop extends RunicMagicCrop
{
	private FeyEthelCrop()
	{
	...
	public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
	{
		...
		ret.add(new ItemStack(FeyEthelWeed.instance));
	...
	public boolean canBlockStay(World world, int x, int y, int z)
	{
		...
		if(!b.equals(FaerieRingGrass.instance))
			return false;
	...
	public static final String name = "Fey Ethel Crop";
	...
	public static final FeyEthelCrop instance = new FeyEthelCrop();
}
