...
defaultproperties
{
	...
	Description="Adds 1 ammo per level to each ammo type you own every 3 seconds. Does not give ammo to superweapons or the translocator. You must have a Max Ammo stat of at least 25 to purchase this ability. (Max Level: 10)"
	StartingCost=5
	CostAddPerLevel=3
	MaxLevel=10
}
