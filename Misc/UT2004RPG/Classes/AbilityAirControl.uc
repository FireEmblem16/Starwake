...
{
	if (Data.Level < 5 * (CurrentLevel + 1))
		return 0;
	else
...
defaultproperties
{
	...
	Description="Increases your air control by 50% per level. You must be a Level equal to five times the ability level you wish to have before you can purchase it. (Max Level: 4)"
	StartingCost=8
	CostAddPerLevel=4
	MaxLevel=4
	BotChance=4
