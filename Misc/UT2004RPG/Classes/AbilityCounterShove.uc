...
defaultproperties
{
	...
	Description="Whenever you are damaged by another player, 25% of the momentum per level (or 150% at level 5) is also done to the player who hurt you. Will not CounterShove a CounterShove. You must have a Damage Reduction of at least 25 to purchase this ability. (Max Level: 5)"
	StartingCost=6
	CostAddPerLevel=0
	MaxLevel=5
}
